...
const IndustrialFireExtinguisher = () => {
    ...
    if (!useHave($item`industrial fire extinguisher`) || foam <= 0)
        return <></>;
    ...
    return (
        ...
        >
            ...
            {showKnob && (
                <Line>
                    You can use Foam the Place to obtain the Knob Harem Outfit
                </Line>
            )}
            {showCyrpt && (
                <Line>
            ...
            {showBlech && (
                <Line>
                    You can use Cool it Down to advance your Blech House timer.
                </Line>
            )}
            {showDesert && (
                <Line>
                    You can use Take a Drink to get 15 turns of Ultrahydrated.
                </Line>
            )}
        </Tile>
    );
