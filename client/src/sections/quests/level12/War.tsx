      ...
      {atStep(step, [
        ...
        [
          ...
          <>
            ...
            <Line>{turnsToSeeNoncombat(85, 3).toFixed(1)} turns expected.</Line>
          </>,
        ],
        [
          1,
          <>
            ...
            {remainingSidequestNames.length > 0 && (
              <>
                <Line>
                  Quests available: {remainingSidequestNames.join(", ")}.
                </Line>
                {nextQuest && (
                  <Line>
