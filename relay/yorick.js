...
var globalThis = __webpack_require__(8793);
...
var tryToString = __webpack_require__(7938);
var getIteratorMethod = __webpack_require__(590);
var $TypeError = TypeError;
...
var anObject = __webpack_require__(4398);
var tryToString = __webpack_require__(7938);
var isArrayIteratorMethod = __webpack_require__(6);
var lengthOfArrayLike = __webpack_require__(7457);
var isPrototypeOf = __webpack_require__(2430);
var getIterator = __webpack_require__(1778);
var getIteratorMethod = __webpack_require__(590);
var iteratorClose = __webpack_require__(9400);
var $TypeError = TypeError;
...
var V8_VERSION = __webpack_require__(9140);
var fails = __webpack_require__(942);
var globalThis = __webpack_require__(8793);
...
var iterate = __webpack_require__(3973);
...
var es_object_from_entries = __webpack_require__(4170);
    ...
    value: function set(propertiesToSet) {
      for (var _i2 = 0, _Object$entries2 = Object.entries(propertiesToSet); _i2 < _Object$entries2.length; _i2++) {
        ...
        if (!(propertyName in this.properties)) {
          this.properties[propertyName] = (0,external_kolmafia_namespaceObject.propertyExists)(propertyName) ? get(propertyName) : PropertiesManager.EMPTY_PREFERENCE;
        }
...
function _toConsumableArray(r) { return _arrayWithoutHoles(r) || _iterableToArray(r) || src_unsupportedIterableToArray(r) || _nonIterableSpread(); }
function _nonIterableSpread() { throw new TypeError("Invalid attempt to spread non-iterable instance.\nIn order to be iterable, non-array objects must have a [Symbol.iterator]() method."); }
function _iterableToArray(r) { if ("undefined" != typeof Symbol && null != r[Symbol.iterator] || null != r["@@iterator"]) return Array.from(r); }
function _arrayWithoutHoles(r) { if (Array.isArray(r)) return src_arrayLikeToArray(r); }
...
var enumeratedTypes = {
  Bounty: external_kolmafia_namespaceObject.Bounty,
  Class: external_kolmafia_namespaceObject.Class,
  Coinmaster: external_kolmafia_namespaceObject.Coinmaster,
  Effect: external_kolmafia_namespaceObject.Effect,
  Element: external_kolmafia_namespaceObject.Element,
  Familiar: external_kolmafia_namespaceObject.Familiar,
  Item: external_kolmafia_namespaceObject.Item,
  Location: external_kolmafia_namespaceObject.Location,
  Monster: external_kolmafia_namespaceObject.Monster,
  Phylum: external_kolmafia_namespaceObject.Phylum,
  Servant: external_kolmafia_namespaceObject.Servant,
  Skill: external_kolmafia_namespaceObject.Skill,
  Slot: external_kolmafia_namespaceObject.Slot,
  Stat: external_kolmafia_namespaceObject.Stat,
  Thrall: external_kolmafia_namespaceObject.Thrall
};
var toIntTypes = {
  Item: external_kolmafia_namespaceObject.Item,
  Familiar: external_kolmafia_namespaceObject.Familiar,
...
function main() {
  ...
  if (body.properties) {
    var valid = body.properties.filter(name => typeof name === "string");
  ...
  (0,external_kolmafia_namespaceObject.writeln)(JSON.stringify(result));
}
